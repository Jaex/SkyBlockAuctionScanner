...
{
    public static class SkyBlockHelpers
    {
        public static string GetItemStars(int itemStars)
        {
            return new string('✪', itemStars);
        }

        public static Color GetItemTierColor(SkyBlockItemTier itemTier)
        {
            switch (itemTier)
            {
                default:
